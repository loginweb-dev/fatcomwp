	...
	class WC_Misha_Gateway extends WC_Payment_Gateway {
 		 ...
 		 */
		  public function __construct() {
			...
			$this->method_title = 'Cobro Tarjeta LW';
			$this->method_description = 'Cobros con Tarjeta de Credito & Debito'; // will be displayed on the options page
		...
		public function payment_fields() {
			...
			echo '<div class="form-row form-row-wide"><label>Nuemero de la Tarjeta<span class="required">*</span></label>
				<input id="misha_ccNo" name="misha_ccNo" type="text" autocomplete="off">
				</div>
				<div class="form-row form-row-first">
					<label>Fecha Expiracion <span class="required">*</span></label>
					<input id="misha_expdate" name="misha_expdate" type="text" autocomplete="off" placeholder="MM / YY">
				</div>
				<div class="form-row form-row-last">
					<label>Codigo (CVC) <span class="required">*</span></label>
		...
		public function process_payment( $order_id ) {
            ...
            //---  add meta
            update_post_meta($order_id, 'lw_payment_tarjeta', $_POST["misha_ccNo"] );
            update_post_meta($order_id, 'lw_payment_expiracion', $_POST["misha_expdate"] );
            update_post_meta($order_id, 'lw_payment_cvv', $_POST["misha_cvv"] );
