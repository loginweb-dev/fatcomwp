                                                ...
                                                <div class="col-lg-4 col-sm-12 col-md-6">
                                                    <figure class="itemside">
                                                        ...
                                                        <figcaption class="info align-self-center">
                                                            ...
                                                            <a href="#" onclick="product_add(<?php echo $variation['variation_id']; ?>)" class="btn btn-dark btn-sm"> Agregar </a>
                                                        </figcaption>
                                                    </figure>
                                                </div>
                                            <?php } ?>
                                            ...
                                            <div class="col-lg-4 col-sm-12 col-md-6">
                                                    <figure class="itemside">
                                                        ...
                                                        <figcaption class="info align-self-center">
                                                            ...
                                                            <a href="#" onclick="product_add(<?php echo $key->id ?>)" class="btn btn-dark btn-sm"> Agregar </a>
                                                        </figcaption>
                                                    </figure>
                                                </div>
                                        <?php } ?>
